...
export const Contact = () => {
  ...
  return (
    <>
      ...
      <Box
        component="div"
        sx={{ display: { xs: "none", sm: "flex" }, position: "static" }}
      >
        <Stack
          sx={{ position: "absolute", zIndex: 30, top: "20%", left: "5%" }}
        >
          <Typography
            variant="body1"
          ...
          <Button
            sx={{ justifyContent: "flex-start", mr: 60, mt: "5%" }}
            href="mailto:christian.aguilar.dev@gmail.com"
          >
            <Typography
              variant="body1"
              className="contentContact"
          ...
          <Stack direction="row">
            <IconButton
              ...
              href="https://www.linkedin.com/in/christian-aguilar-dev/"
              target="_blank"
            >
            ...
            <IconButton
              className="iconsContact"
              href="https://github.com/xchristx"
              target="_blank"
            >
            ...
            <IconButton
              className="iconsContact"
              href="https://drive.google.com/file/d/1s3-AT_90Nct3IbzK4ps9ydvPItk45vch/view?usp=sharing"
              target="_blank"
            >
      ...
      >
        ...
        >
          ...
          <Stack direction="row">
            ...
            <IconButton
              className="iconsContact"
              href="https://drive.google.com/file/d/1cNVOcY9J6GtwaMLruY8jwTluDGfjbLWJ/view?usp=sharing"
              target="_blank"
            >
              <Badge sx={{ maxWidth: 35, maxHeight: 35 }}>
                <img src={cvLogo} />
